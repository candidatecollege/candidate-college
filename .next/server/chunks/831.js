...
const Footer = ()=>{
    ...
    const [isLoadingArticles, setIsLoadingArticles] = (0,react_.useState)(true);
    const [events, setEvents] = (0,react_.useState)([]);
    const [isLoadingEvents, setIsLoadingEvents] = (0,react_.useState)(true);
    const fetchArticles = async ()=>{
        setIsLoadingArticles(true);
        try {
            const response = await axios/* default */.Z.get(`https://resource.candidatecollegeind.com/api/articles?count=4`);
            setTimeout(()=>{
    ...
    const fetchEvents = async ()=>{
        setIsLoadingArticles(true);
        try {
            const response = await axios/* default */.Z.get(`https://resource.candidatecollegeind.com/api/events?count=4`);
            setTimeout(()=>{
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0,jsx_runtime_.jsx)("ul", {
                                                className: "flex flex-col gap-2",
                                                children: events.map((event, index)=>/*#__PURE__*/ (0,jsx_runtime_.jsx)((link_default()), {
                                                        className: "text-sm text-gray font-normal hover:text-white duration-700 transition-all",
                                                        href: event && event.link_registration,
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0,jsx_runtime_.jsx)("ul", {
                                            ...
                                            children: articles.map((article, index)=>/*#__PURE__*/ (0,jsx_runtime_.jsx)((link_default()), {
                                                    ...
                                                    about: article && article && article.title,
                                                    children: article && article && article.title.substring(0, 70) + "..."
                                                }, index))
                                        })
                                    ]
                                })
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0,jsx_runtime_.jsx)("ul", {
                            ...
                            children: articles.map((article, index)=>/*#__PURE__*/ (0,jsx_runtime_.jsx)((link_default()), {
                                    ...
                                    children: article && article.title.substring(0, 70) + "..."
                                }, index))
                        })
                    ]
                })

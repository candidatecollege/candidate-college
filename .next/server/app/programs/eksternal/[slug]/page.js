...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 74568)), "/Users/afarhanagustiansyah/Desktop/Candidate College/candidate-college/src/app/programs/eksternal/[slug]/page.tsx"],
    ...
    const pages = ["/Users/afarhanagustiansyah/Desktop/Candidate College/candidate-college/src/app/programs/eksternal/[slug]/page.tsx"];
    
    const originalPathname = "/programs/eksternal/[slug]/page"
    const __next_app__ = {
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 25656))
...
/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(64831);
...
const Detail = ()=>{
    const slug = (0,next_navigation__WEBPACK_IMPORTED_MODULE_4__.usePathname)().slice(20);
    const [event, setEvents] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(null);
    ...
    const fetchEvents = async ()=>{
        setIsLoading(true);
        try {
            const response = await axios__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .Z.get(`https://resource.candidatecollegeind.com/api/events/${slug}`);
            setTimeout(()=>{
    ...
    const [relatedEventes, setRelatedEvents] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [isLoadingRelatedEvents, setIsLoadingRelatedEvents] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(true);
    const fetchRelatedEvents = async ()=>{
        setIsLoadingRelatedEvents(true);
        const id = (0,_utils_category__WEBPACK_IMPORTED_MODULE_8__/* .categoryId */ .C)(event && event.category, [
            "All",
            "Students",
            "Education",
            "Gen Z",
        ...
        try {
            const response = await axios__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .Z.get(`https://resource.candidatecollegeind.com/api/event/categories/${id}`);
            setTimeout(()=>{
    ...
    const links = (0,_utils_socials__WEBPACK_IMPORTED_MODULE_9__/* .generateShareLinks */ .p)(event && event.name, `https://candidatecollegeind.com/articles/${event && event.slug}`);
    const socials = [
        {
            id: 1,
            name: "Twitter",
            ...
            isLoading ? /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("section", {
                ...
                children: [
                                ...
                                children: [
                                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("p", {
                                        ...
                                        children: [
                                            ...
                                            " Min Read  \xa0 | \xa0 ",
                                            (0,_utils_time__WEBPACK_IMPORTED_MODULE_13__/* .formatDate */ .p6)(event && event.created_at),
                                            " | \xa0 ",
                                            event && event.author
                                        ]
                                    }),
                    ...
                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", {
                        ...
                        children: isLoadingRelatedEvents ? loadingContents.slice(0, 3).map((event, index)=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_CardItemLandscape__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z, {
                                data: event,
                                isLoading: true
                            }, index)) : relatedEventes.slice(0, 3).map((event, index)=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_CardItemLandscape__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z, {
                                data: event,
                                isLoading: false
                            }, index))
                    })
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/Users/afarhanagustiansyah/Desktop/Candidate College/candidate-college/src/app/programs/eksternal/[slug]/page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [323,604,750,298,831,914], () => (__webpack_exec__(12995)));

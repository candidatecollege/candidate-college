...
const CardCLevel = (props: any) => {
  ...
  return (
    <div className="flex justify-center mt-7 group">
      {/* Picture */}
      <div className="flex flex-col bg-primary w-56 h-56 rounded-lg shadow-lg hover:bg-sky-950 transition duration-700 ease-in-out justify-end items-center group" onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)}>
